...
public class ScreenTest {
	...
	public void addScreenTest() {
		...
		assertThrows(TheatreNotFoundException.class, ()->{screenService.addScreen((long)101, screen1);});
	...
	public void getAllScreenTest()
	{
		...
		when(theatreRepo.existsById((long)101)).thenReturn(false);
		assertThrows(TheatreNotFoundException.class, ()->{screenService.getAllScreen((long)101);});
	...
	public void deleteScreenTest() throws ScreenNotFoundException
	{
		...
		assertThrows(ScreenNotFoundException.class, ()->{screenService.deleteScreen((long)110);});
	}
	...
	public void addSeatTest() throws ScreenNotFoundException,InvalidAttributeException
	{
		...
		when(screenRepo.existsById(screen1.getScreenId())).thenReturn(true);
		when(screenRepo.findById(screen1.getScreenId())).thenReturn(Optional.of(screen1));
		assertThrows(InvalidAttributeException.class,()->{screenService.addSeats(screen1.getScreenId(), 0);});
		
		when(screenRepo.existsById((long)111)).thenReturn(false);
		assertThrows(ScreenNotFoundException.class,()->{screenService.addSeats(111, 75);});
	...
	public void updateSeatTest() throws ScreenNotFoundException
	{
		...
		when(screenRepo.existsById(screen1.getScreenId())).thenReturn(true);
		when(screenRepo.findById(screen1.getScreenId())).thenReturn(Optional.of(screen1));
		assertThrows(InvalidAttributeException.class,()->{screenService.updateNoOfSeats(screen1.getScreenId(), 0);});
		
		when(screenRepo.existsById((long)111)).thenReturn(false);
		assertThrows(ScreenNotFoundException.class,()->{screenService.updateNoOfSeats(111, 75);});
	...
	public void getNoOfSeatTest() throws ScreenNotFoundException
	{
		...
		when(screenRepo.existsById((long)111)).thenReturn(false);
		assertThrows(ScreenNotFoundException.class,()->{screenService.getNoOfSeats(111);});
