...
class BookingTest {
	...
	public void getBookingTest() {
		...
		assertThrows(BookingNotFoundException.class, () ->{ bookingService.getBooking(booking.getBookingId());});
	}
	...
	public void getPreviousBookingTest() {
	    ...
	    assertThrows(CustomerNotFoundException.class,()->{bookingService.getPreviousBookings(new Long(1190));});
	}
